                  ...
                  <div className='sidebar' id='side_nav'>
                      <div className='header-box px-2 pt-3 pb-4'>
                          ...
                          <ul className='list-unstyled px-2'>
                              <NavLink to='/manager' className={({isActive}) => isActive && pathname === '/manager' ? 'active' : null} id='links'>
                              ...
                              <NavLink to='final-inspect' className={({isActive}) => isActive? 'active' : null} id='links'>
                                  <li><a className='text-decoration-none px-3 py-2 d-block fs-5'><i class='bi bi-clipboard-check-fill me-3 fs-5' />Final Inspection</a></li>
                              </NavLink>
                  ...
                  <div className='content'>
                      <nav className='navbar bg-body-tertiary'>
                        <div className='container-fluid'>
                          <span className='navbar-brand my-2 ps-3 h1 fs-4'>Inspection System</span>
