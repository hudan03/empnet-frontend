...
function FinalInspection() {
    ...
    const getWo = async () => {
        const response = await api.get('/wo/final');
                ...
                <div className='modal-dialog modal-dialog-centered'>
                    <div className='modal-content'>
                        <div className='modal-header'>
                            <h1 className='modal-title fs-5' id='staticBackdropLabel'>Final Inspection</h1>
                        ...
                        <form onSubmit={() => handleUpdate(woID)}>
                            ...
                            <div className='modal-footer'>
                                ...
                                <button progress='submit' className='btn btn-success'>Approve</button>
                            </div>
                        </form>
                    </div>
                </div>
